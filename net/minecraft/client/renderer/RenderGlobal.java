...
public class RenderGlobal implements IWorldAccess
{
    ...
    public int glExtendedListBase = 0;
    ...
    public RenderGlobal(Minecraft par1Minecraft)
    {
        ...
        int countListSmooth = countWorldRenderers * 2 * 2 * 16;
        int countListThreaded = countWorldRenderers * 2;
        int countExtendedRenderLists = Math.max(countListSmooth, countListThreaded);
        int countAllRenderLists = countStandardRenderLists + countExtendedRenderLists;
        this.glRenderListBase = GLAllocation.generateDisplayLists(countAllRenderLists);
        this.glExtendedListBase = this.glRenderListBase + countStandardRenderLists;
            ...
            for (var10 = 0; var10 < this.renderChunksWide; ++var10)
            {
                for (int var15 = 0; var15 < this.renderChunksTall; ++var15)
                {
                    for (int cz = 0; cz < this.renderChunksDeep; ++cz)
                    {
                        ...
                        this.worldRenderers[wri] = WrUpdates.makeWorldRenderer(this.theWorld, this.tileEntities, var10 * 16, var15 * 16, cz * 16, this.glRenderListBase + var2, var3);
        ...
        else
        {
            ...
            for (var18 = 0; var18 < this.tileEntities.size(); ++var18)
            {
                ...
                if (!hasTileEntityShouldRenderInPass || Reflector.callBoolean(var27, Reflector.ForgeTileEntity_shouldRenderInPass, new Object[] {Integer.valueOf(pass)}))
                {
                    ...
                    if (p_147589_2_.isBoundingBoxInFrustum(var29))
                    {
    ...
    public AxisAlignedBB getTileEntityBoundingBox(TileEntity te)
    {
        ...
        else if (blockType != Blocks.chest && blockType != Blocks.trapped_chest)
        {
            ...
            {
                AxisAlignedBB blockAabb = te.getBlockType().getCollisionBoundingBoxFromPool(te.getWorldObj(), te.field_145851_c, te.field_145848_d, te.field_145849_e);
